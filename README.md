...
Project developed to demonstrate the use of intelligent agents on the web.
...
Component-based Architecture – React component-driven architecture

File-based Routing – File-based routing with React Router

Server State Management – Server state handling using React Query
